...
@Tag("smoke")
class MexcMarketStatsClientSmokeTest {

    @Test
    void fetch_spot_and_perp_BTCUSDT_havePositiveVolume() {
        assumeOnline();

        var client = new MexcMarketStatsClient();

        var spotA = new MarketRef("BTC", "MEXC", "SPOT", "BTC_USDT");
        var spotB = new MarketRef("BTC", "MEXC", "SPOT", "BTCUSDT"); // на всякий случай
        var perpA = new MarketRef("BTC", "MEXC", "PERP", "BTC_USDT");
        var perpB = new MarketRef("BTC", "MEXC", "PERP", "BTCUSDT");
